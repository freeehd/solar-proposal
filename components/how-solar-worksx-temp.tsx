  ...
  return (
      <section className="relative h-screen  bg-gray-900">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center px-4 text-white">
          ...
          >
            <h2 className="text-5xl md:text-6xl font-extralight mb-4">How Solar Works</h2>
            <motion.div
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <h3 className={`text-3xl md:text-4xl font-light mb-6 ${scenarios[activeScenario].textColor}`}>
                {scenarios[activeScenario].title}
              </h3>
              <p className={`text-lg md:text-xl mb-12 ${scenarios[activeScenario].textColor} opacity-90 leading-relaxed`}>
          ...
          <div className="flex justify-center items-center space-x-8">
            ...
            >
              <Sun className={`h-6 w-6 mr-2 ${activeScenario === "day" ? "text-white" : "text-amber-400"}`} />
              Daytime
            </Button>
            <Button
                variant="outline"
            ...
            >
              <Moon className={`h-6 w-6 mr-2 ${activeScenario === "night" ? "text-white" : "text-blue-400"}`} />
              Nighttime
            </Button>
          </div>
        </div>
        ...
        <Button
            ...
            onClick={() => switchScenario(activeScenario === "day" ? "night" : "day")}
        >
