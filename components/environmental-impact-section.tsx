  ...
  return (
    <section className="py-20 bg-gradient-to-b from-background to-gray-900">
      <div className="container mx-auto px-4">
        ...
        >
          Going solar is good for your wallet and the planet. Install solar panels and save as much CO2 as:
        </motion.p>
          ...
          <motion.div variants={cardVariants} initial="hidden" animate="visible" transition={{ delay: 0.3 }}>
            <Card className="bg-card/50 backdrop-blur border-primary/10">
              <CardContent className="flex flex-col items-center justify-center p-8">
                ...
                <p className="text-5xl font-bold mb-2 text-primary">390</p>
          ...
          <motion.div variants={cardVariants} initial="hidden" animate="visible" transition={{ delay: 0.4 }}>
            <Card className="bg-card/50 backdrop-blur border-primary/10">
              <CardContent className="flex flex-col items-center justify-center p-8">
                ...
                <p className="text-5xl font-bold mb-2 text-primary">4,305</p>
