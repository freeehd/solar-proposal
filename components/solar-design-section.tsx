...
export default function SolarDesignSection({
  ...
  const handleChargingComplete = useCallback(
    (iconKey: keyof typeof chargingStates) => {
      setTimeout(() => {
      ...
      <div className="container relative mx-auto px-4" ref={containerRef}>
          ...
          >
            ...
            >
              ...
              <p className="text-slate-600 max-w-2xl mx-auto text-lg">
                Designed exclusively for your home's energy profile, our premium
                solar system delivers exceptional performance and maximum
                long-term value.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-blue-100/50 to-white shadow-xl border border-blue-100/50">
                <Image
                  src={"/solar.png?height=600&width=800"}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <p className="text-sm text-white/90">
                    Optimized placement for maximum sun exposure
                  </p>
                </div>
              </div>
              ...
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-blue-100/50 to-white shadow-xl border border-blue-100/50">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <p className="text-sm text-white/90">
                    Energy storage for continuous power supply
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-12">
              ...
              <motion.div className="col-span-1 md:col-span-2">
                <Card className="bg-white/90 backdrop-blur-xl border border-blue-100/50 shadow-2xl overflow-visible rounded-xl">
                  <CardContent className="pt-10 pb-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12">
                      {/* Premium Icons Grid - Each icon wrapper */}
                      <div className="flex flex-col items-center space-y-5">
                        {/* Remove nested relative divs, keep only one at icon level */}
                        {/* Icon placeholder */}
                        <div ref={icon1Ref} className="w-28 h-28" />
                        <motion.div
                          animate={{
                      ...
                      {/* Apply the same structure to other icons */}
                      <div className="flex flex-col items-center space-y-5">
                        {/* Icon placeholder */}
                        <div ref={icon2Ref} className="w-28 h-28" />
                        <motion.div
                          animate={{
                      ...
                      <div className="flex flex-col items-center space-y-5">
                        {/* Icon placeholder */}
                        <div ref={icon3Ref} className="w-28 h-28" />
                        <motion.div
                          animate={{
                      ...
                      <div className="flex flex-col items-center space-y-5">
                        {/* Icon placeholder */}
                        <div ref={icon4Ref} className="w-28 h-28" />
                        <motion.div
                          animate={{
              ...
              <motion.div>
                <Card className="bg-white/90 backdrop-blur-xl border border-blue-100/50 shadow-2xl h-full rounded-xl">
                  <CardContent className="flex flex-col items-center pt-8">
                    {/* Circle placeholder */}
                    <div ref={circleRef} className="w-52 h-52" />
                    <motion.div
            ...
            <motion.div className="mt-16 relative isolate">
              <Card className="bg-white/90 backdrop-blur-xl border border-blue-100/50 shadow-2xl overflow-hidden rounded-xl">
                ...
                <CardContent className="pt-10 pb-8">
                  ...
                  >
                    Our premium solar panels utilize cutting-edge photovoltaic
                    technology to maximize energy conversion efficiency.
                    Engineered with premium materials, they deliver exceptional
                    performance in all weather conditions with an
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    >
                      <PremiumIcon className="w-24 h-24 mb-5" isCharging={true}>
        ...
        {hasStarted && (
          <div
            ...
            style={{ zIndex: "var(--z-index-beams)" }}
          >
            <BeamOverlay
